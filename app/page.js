            ...
            {showBio && (
              <div className={showBio ? "relative flex justify-between items-center w-full max-w-12x1 mt-10 p-8 bio-container bio-fade-in" : ""}>
                <div className="text-left w-1/2 pr-8">
                  <h2 className="about-me-title-position about-me-tile-font-size haken-static-color font-bold">Sobre mim</h2>
            ...
            {showProjects && (
              <div className={showProjects ? "relative flex justify-between items-center w-full max-w-12x1 mt-10 p-8 bio-container bio-fade-in" : ""}>
                ...
                <div className="projects-title">
                  <h2 className="font-bold projects-title-size haken-static-color">Meus Projetos</h2>
                </div>
          ...
          <button onClick={handleThirdButtonClick} className={thirdButtonClicked ? "contacts-scale rounded-full scale-down-third-button bg-buttons text-white py-4 px-8 mb-8" : "rounded-full buttons button-fade-in bg-buttons text-white py-4 px-8 mb-8"} disabled={thirdButtonClicked}>
            ...
            {showContacts && (
              <div className={showContacts ? "relative flex justify-between w-full max-w-12x1 mt-10 p-8 bio-container bio-fade-in" : ""}>
                <div className="contacts-top contacts-text-centralize">
                  <h2 className="text-4xl font-bold mb-4 haken-static-color">Meus Contatos</h2>
                </div>
                ...
                <div className={showContacts ? "contacts-image-centralize flex bio-fade-in" : ""}>
                  <a href="https://www.instagram.com/marco_antonio.fc/" target="_blank">
                      <button>
                            <svg class="w-20 h-20 icon-colors" fill="currentColor" viewBox="0 0 448 512" aria-hidden="true">
                  ...
                  <a href="https://github.com/Marco4325" target="_blank">
                      <button>
                            <svg class="w-20 h-20 icon-colors" fill="currentColor" viewBox="0 0 496 512" aria-hidden="true">
                                <path fill-rule="evenodd"
